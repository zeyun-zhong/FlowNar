...
from torch.distributed._tensor.api import distribute_module
from torch.distributed.tensor.parallel import ParallelStyle

from models.clustering.utils import get_multiprocessor_count, input_guard
...
def layer_norm_fwd_kernel(
    ...
    y = x_hat * w + b if HAS_WEIGHT and HAS_BIAS else \
