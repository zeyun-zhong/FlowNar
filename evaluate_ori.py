...
from engine import TrainerWithGenToEval, TrainerWithGenToEvalSaveAttention
...
def evaluate():
    ...
    trainer_cls = TrainerWithGenToEvalSaveAttention if args.output_attentions else TrainerWithGenToEval
    trainer = trainer_cls(
