...
deepspeed train.py --deepspeed configs/deepspeed/zero2.json \
    ...
    --report_to wandb \
    --max_grad_norm 1.0 \
    --run_name memory20_narrationlast10_zero2_llama1B_bs64_lr0.0002_gradnorm1 \
    --max_num_frames 1200 \
    --data_root /hkfs/work/workspace_haic/scratch/on3546-Dataset_Long_new/FlowNar-Data/ego4d \
    --output_dir outputs/ego4d_refined_narration_stream_train_memory20_narrationlast10_zero2_1B/live1+ \
